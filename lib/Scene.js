...
var Scene = function () {
    ...
    _createClass(Scene, [{
        ...
        key: '_adjustBoxZoomOffset',
        value: function _adjustBoxZoomOffset(box, originX, originY, zoomDelta) {
            var _zoomOffset2 = this._zoomOffset(originX, originY, box.x + box.offsetX, box.y + box.offsetY, zoomDelta),
